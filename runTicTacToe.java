...
public class runTicTacToe {
	...
	public int run()
	{
		...
		while((result = isEnded())==0) //game loop
		{
			...
			{
				//positionTicTacToe player2NextMove = ai2.RANDOMALGORITHM(board,2); //2 stands for player 2; random ai
				positionTicTacToe player2NextMove = ai2.myAIAlgorithm(board,2); //2 stands for player 2; minimax AI
	...
	public static void main(String[] args) {		
		...
		System.out.println("Player one won " + Integer.toString(playeronewins) + " times.");
		System.out.println("Player two won " + Integer.toString(playertwowins) + " times.");
